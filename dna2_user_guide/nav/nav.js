function create_menu(basepath)
{
	...
	document.write(
		...
		'<h3>Installation</h3>' +
		'<ul>' +
			'<li><a href="'+base+'installation/downloads.html">Downloading DNA&sup2;</a></li>' +
		...
		'<ul>' +
			...
			'<li><a href="'+base+'overview/at_a_glance.html">DNA&sup2; at a Glance</a></li>' +
			'<li><a href="'+base+'overview/cheatsheets.html">DNA&sup2; Cheatsheets</a></li>' +
		...
		'<ul>' +
			'<li><a href="'+base+'general/urls.html">DNA&sup2; URLs</a></li>' +
			...
			'<li><a href="'+base+'general/libraries.html">Using DNA&sup2; Libraries</a></li>' +
