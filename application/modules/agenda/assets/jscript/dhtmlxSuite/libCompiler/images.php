...
*/\n";
	...
	function replaceComments($data){
		...
		$data=str_replace(':"/*',"___XPATH_HEAD21___",$data);
		$data=str_replace('(".//',"___XPATH_HEAD3___",$data);
		$data=str_replace('/*")',"___XPATH_HEAD4___",$data);
		$data=str_replace('http://',"___XPATH_HEAD5___",$data);
		$data=str_replace('SAIAAAP///////',"___XPATH_HEAD6___",$data);
		...
		$data=str_replace("___XPATH_HEAD4___",'/*")',$data);
		$data=str_replace("___XPATH_HEAD4___",'/*")',$data);
		$data=str_replace("___XPATH_HEAD5___",'http://',$data);
		$data=str_replace("___XPATH_HEAD6___",'SAIAAAP///////',$data);
	...
	function replaceCssWhitespaces($css_code){
