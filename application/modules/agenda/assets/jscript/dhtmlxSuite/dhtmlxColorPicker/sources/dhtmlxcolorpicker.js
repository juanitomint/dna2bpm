...
/**
*     @desc: create colorpicker for input in question
...
X = (document.compatMode!="BackCompat"?"X":"");
   ...
   if (!this.fullview)
	   this.elements['cs_SelectorDiv'].style.backgroundImage='url('+(this.imgURL||"")+'colormini.png)';
   else
	   this.elements['cs_SelectorDiv'].style.backgroundImage='url('+(this.imgURL||"")+'color.png)';	
...
dhtmlXColorPicker.prototype.close = function()
{
   ...
   if (this.cc)
      this.elements['cs_CustomColorAdd'].z = null;
