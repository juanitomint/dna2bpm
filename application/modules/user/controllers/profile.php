...
class Profile extends MX_Controller {
    ...
    function Edit() {
        ...
        if ($genero == "female")
            $customData['checkedF'] = 'checked';
        else
            $customData['checkedM'] = 'checked';
        ...
        if ($img_avatar["name"]) {
            ...
            if ($avatarFoto == "nohay") {
                if ($post_obj['gender'] == "male")
                    ...
                    $post_obj['avatar'] = "images/avatar/female.jpg";
            }
        }
    ...
    function View() {
        ...
        if ($genero == "female")
            $customData['checkedG'] = 'femenino';
        if ($genero == "male")
            $customData['checkedG'] = 'masculino';
