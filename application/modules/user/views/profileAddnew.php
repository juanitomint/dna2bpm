...
<form class="form-horizontal" action="{module_url}profile/addnew" method="POST">
    <legend>Agregar usuario al grupo </legend>
    ...
    <div class="control-group">
    <span class="btn btn-file controls"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span><input type="file" /></span>
