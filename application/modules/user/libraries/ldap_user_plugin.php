...
public $ldap_server = '192.168.1.11';
public $ldap_port = '390';
public $ldaprdn = 'cn=zentyal,dc=s1,dc=local';
public $ldappass = 'yzNRgV8fP4gL@eKCKfkq';
public $baseDN = "ou=Users,dc=s1,dc=local";
public $groupsDN = "ou=Groups,dc=s1,dc=local";
