                            ...
                            <div class="renderEditCol column pregunta">
                                ...
                                <div class="ui-widget">
                                    <div style="padding: 0pt 0.7em; margin-top: 20px;" class="ui-state-highlight ui-corner-all"> 
                                        <p><span style="float: left; margin-right: 0.3em;" class="ui-icon ui-icon-info"></span><br/>
                                ...
                                <span class='titulopreg'>
                                    ...
                                    {if {has_id}}
                                    <a id="showHist" idframe="{idframe}" title="{showHistory}" ><span class="ui-corner-all ui-state-default ui-icon ui-icon-clock" id="hist{cname}" ></span></a>
                                    {/if}
                                    {cname}
                                    {title}
                                </span>
