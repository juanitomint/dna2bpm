            ...
            <li>
                ...
                <div class="tools">
                    <a href='{base_url}bpm/engine/run/model/{idwf}/{id}'>
                        <i class="fa fa-2x fa-play play_case"></i>{lang play}
                    </a>
                    {if {isAdmin}}
                    <a href='{base_url}bpm/engine/startcase/model/{idwf}/{id}'>
                        <i class="fa fa-2x fa-refresh restart_case"></i>{lang restart}
                    </a>
                    <a href='{base_url}bpm/tokens/view/{id}'>
                        <i class="fa fa-2x fa-rotate-270 fa-sitemap  restart_case"></i>{lang tokens}
                    </a>
                    <a href='{base_url}bpm/case_manager/archive/model/{idwf}/{id}' title="Archive" class="load_modal">
                        <i class="fa fa-2x fa-archive archive_case"></i>{lang archive}
                    </a>
                    {/if}
                </div>
                <p>
