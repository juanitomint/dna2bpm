...
var flat={};
var first=false;
var exclude_shape=new Array('SequenceFlow','Pool','MessageFlow','Association_Undirected','TextAnnotation');
var exclude_paint=new Array('Pool','Lane','TextAnnotation','Association_Undirected');
