...
function prep_pdf($orientation = 'portrait')
{
	...
	$CI->cezpdf->selectFont('application/modules/meetings/assets/fonts/Helvetica');	
	...
	if($orientation == 'portrait') {
		...
		$CI->cezpdf->addText(50,32,8,'Generado ' . date('d/m/Y H:i'));
		$CI->cezpdf->addText(50,22,8,'SePyME');
	}
	else {
